...
lifetimeThreshold = 7.5;         % Keep tracks ≥ 5 frames long
...
% load once
E = load("lambda2_data\allCentroids_14-3600_thresh3p5_area6_OrigCoords_blur_3x3.mat", "allCentroids");
...
yyaxis right
plot(W_thr_list, accuracy_by_Wthr, '-o', ...
     'LineWidth',1.5,'MarkerSize',6);
ylabel('Matching accuracy','Interpreter','latex');
ylim([0, 1]);        % since accuracy is a fraction
...
% Legend
legend({ 'Total matches', 'Matching accuracy' }, ...
...
fname = 'output/accuracyAndMatchesAsFuncOfWaveletThresholdProfilometry_s8_Run2_lambda2_3_minArea6_blur_rad10';

...
%% Preprocess the file to replace commas with periods
...
% Integral time scale T_int = ∫₀^{τ₀} R(τ) dτ
T_int = trapz(lags_pos(1:zc), R_pos(1:zc));

% Convert to length scale L = U_mean * T_int
...
% plot the normalized autocorrelation and mark zero crossing
figure;
